<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Home.Master" CodeBehind="HairEngineerList.aspx.cs" Inherits="Web.HairEngineerList" %>
<asp:Content ContentPlaceHolderID="BodyContentPosition" ID="BodyContent" runat="server">
<!--搜美发师开始 -->
<div id="main-top">
 <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="7%" align="left" background="Theme/Images/sg-meifa_04.gif"><img src="Theme/Images/search-fxs.gif" /></td>
                  ...
                  <td width="98%" class="search-bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <form method=post action=# target=_blank>
                        <td width="16%" align="center" class="gray12-c">按剪发价格搜索:</td>
                        <td width="16%" class="gray-search"><select name="select2">
					  ...
					  <td width="24%"><input name="textfield" type="text" class="search-input" value="输入发型师姓名" onclick="javascript:if(this.value.substring(0,4)=='输入关键') this.value='';" /></td></form>
      ...
      <div class="pinglun">
        <table width="704" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <td width="3" bgcolor="#F7F7F7" ></td>
            ...
            <td width="138" align="left" background="Theme/Images/fair-mft08.gif">共找到 <span class="red12b">213</span> 家美发厅</td>
            <td width="407" align="left" background="Theme/Images/fair-mft08.gif"><img src="Theme/Images/fair-mft09.gif" width="23" height="7" /></td>
            <td width="141" align="left" background="Theme/Images/fair-mft08.gif">共 10 页 <a href="#" class="gray12-d">上一页</a> <a href="#" class="gray12-d">下一页</a></td>
          </tr>
        </table>
		<table width="704" border="0" cellspacing="0" cellpadding="0">
          <tr>
              ...
              <tr>
                ...
                <td width="561" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="gray12-lp">
                  <tr>
                    ...
                    <td width="12%">[姓名]</td>
                    <td width="20%" class="red12"><strong>赛特丹尼</strong></td>
                    <td width="12%">[所属店]</td>
                    <td width="19%">影博沙</td>
                    <td width="10%">[好评]</td>
                    <td colspan="2"><span class="red12">50%</span></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>[区域]</td>
                    ...
                    <td>[电话]</td>
                    <td>010-65498315</td>
                    <td colspan="3" rowspan="2" valign="top"><a href="#" target="_blank"><img src="Theme/Images/mfs_list_map.gif" width="59" height="19" border="0" /></a></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>[从业时间]</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>[技术擅长]</td>
                    <td colspan="6">恋恋红尘冲好评元/ML法国香料精品纯正香水恋恋红尘冲好评</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    ...
                    <td>&nbsp;</td>
                    <td colspan="3">&nbsp;</td>
                    <td width="18%"><a href="#" class="red12" style=" text-decoration:underline">查 看</a> | <a href="#" style=" text-decoration:underline">我要评论</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
...
<div class="main-r-box">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left"><table width="258" height="33" border="0" cellpadding="0" cellspacing="0" style="margin-left:1px;">
              <tr>
                <td width="108" height="33" style="border-left:#d5d5d5 1px solid;border-top:#d5d5d5 1px solid;border-right:#d5d5d5 1px solid;"><div id="box1" onclick="showPage(1)">发型师关注度榜</div></td>
    ...
    <div class="main-r-box2">
	  ...
	  <table width="98%" height="254" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;margin-bottom:3px">
        <tr>
          <td width="5%" align="left" valign="top" class="gray14-e">&nbsp;</td>
          <td width="92%" height="254" align="left" valign="top"  style="line-height:30px;" ><span class="tag_1"><a href="#">发型</a></span>  <span class="tag_5"><a href="#">发型设计</a></span>  流行发型  <span class="tag_3"><a href="#">新娘发型</a></span><br />
	...
	<div class="main-r-box2">
	  <table width="100%" height="43" border="0" cellpadding="0" cellspacing="0" style="margin-top:20px">
        <tr>
          <td height="24" align="left" class="red14b">&nbsp;&nbsp;美发圈达人&nbsp;<img src="Theme/Images/sg-meifa_35.gif" width="9" height="13" /></td>
        </tr>
        <tr>
          <td height="19"><img src="Theme/Images/sg-meifa_46.gif" width="256" height="2" /></td>
        </tr>
      </table>
	  <table width="98%" height="61" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;margin-bottom:3px">
        <tr>
          <td width="6%" align="left" valign="top" class="gray14-e">&nbsp;</td>
          <td width="27%" height="61" align="left" valign="top" class="gray14-e"><a href="#" target="_blank"><img src="Theme/Images/sg-meifa_ls02.gif" alt="图片说明" width="57" height="57" class="pic_padding_glay" /></a></td>
          <td width="67%" align="left" valign="top" class="gray14-e"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="26" class="gray14-e"><a href="#" target="_blank">艾琳多南：令人惊诧艾</a></td>
            </tr>
            <tr>
              <td height="25" class="gray14-e"><a href="#" target="_blank">艾琳多南：令人惊诧艾</a></td>
            </tr>
          </table></td>
        </tr>
      </table>
	...
	<div class="main-r-box">
	    <table width="100%" height="41" border="0" cellpadding="0" cellspacing="0" style="margin-top:20px">
          <tr>
            <td height="28" align="left" class="red14b">&nbsp;&nbsp;最新发型秀&nbsp;<img src="Theme/Images/sg-meifa_35.gif" width="9" height="13" /></td>
          </tr>
          <tr>

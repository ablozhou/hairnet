...
namespace Web.Admin
{
    public partial class HairEngineerRecommandAdmin : System.Web.UI.Page
    {
        ...
        {
            List<HairEngineerRecommand> list = InfoAdmin.GetHairEngineerRecommands(0);

            Session["num"] = 0;
            this.dg.DataKeyField = "HairEngineerRecommandID";
        ...
        public void dg_OnItemCommand(object sender, DataGridCommandEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                {
                    int hairEngineerRecommandID = int.Parse(this.dg.DataKeys[e.Item.ItemIndex].ToString());
                    
                    if (InfoAdmin.RecommandHairEngineer(0, hairEngineerRecommandID, string.Empty, string.Empty, UserAction.Delete))
                    {
        ...
        public void dg_OnItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                HairEngineerRecommand hairEngineerRecommand = e.Item.DataItem as HairEngineerRecommand;
                ...
                int recommandRate = hairEngineerRecommand.HairEngineerHits + hairEngineerRecommand.HairEngineerGood + hairEngineerRecommand.HairEngineerRecommandNum;

                lblRecommandRate.Text = recommandRate.ToString();
                //评论数（好评+坏评数）
                int commentTotal = hairEngineerRecommand.HairEngineerGood + hairEngineerRecommand.HairEngineerBad;
                ...
                {
                    commentRate = Convert.ToDouble(hairEngineerRecommand.HairEngineerGood) / Convert.ToDouble(commentTotal);
                }

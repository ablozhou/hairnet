<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PictureStoreGroupEdit.aspx.cs" Inherits="Web.Admin.PictureStoreGroupEdit" %>
...
<body>
    ...
    分类名称:<asp:TextBox ID="txtLittleGroupname" runat="server" Width="200"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
            ControlToValidate="txtLittleGroupname" ErrorMessage="字符串长度不得超过40及有非法字符" 

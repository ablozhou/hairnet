                            ...
                            while (sdr.Read())
                            {
                                ...
                                switch(num)
                                {
                                    case 1:
                                        ...
                                        sb.Append("<td align=\"left\" colspan=\"2\"><table width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">");
                                        sb.Append("<tr>");
                                        ...
                                        sb.Append("<td width=\"65%\" align=\"left\"><span class=\"gray14-b\"><a href=\"PrintCoupon.aspx?id=" + couponID + "\" target=\"_blank\">" + StringHelper.GetDescription2(couponName,6) + "</a></span><br />");
                                    ...
                                    case 2:
                                        ...
                                        sb.Append("<td align=\"left\" class=\"gray14-e\" width=\"50%\"><a href=\"PrintCoupon.aspx?id=" + couponID + "\" target=\"_blank\">" + StringHelper.GetDescription2(couponName, 6) + "</a></td>");
                                        sb.Append("<td align=\"left\" class=\"gray12-c\" width=\"35%\">推荐指数:" + hitNum + "</td>");
                                        sb.Append("</tr>");
                                        break;
                                    case 3:
                                        sb.Append("<tr>");

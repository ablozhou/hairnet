<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="Web.Admin.UserEdit" %>
...
<body>
    ...
    <br />
    <asp:Button ID="btnSubmit" runat="server" Text="修改" OnClick="btnSubmit_OnClick" />
    </div>
    </form>
</body>
</html>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HairShopCommentAdmin.aspx.cs" Inherits="Web.Admin.HairShopCommentAdmin" %>
      ...
      <table width="98%" border="0" cellpadding="3" cellspacing="0" class="table2">
        ...
        <asp:DataGrid ID ="dg" runat = "server" PageSize="30" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="HairShopID" HeaderText="美发厅"></asp:BoundColumn>

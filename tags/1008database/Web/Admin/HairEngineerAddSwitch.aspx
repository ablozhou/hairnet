...
<body>
    ...
    <br /><br /><asp:Button ID="btnAddOupusInfo" runat="server" OnClick="btnAddOupusInfo_Click" Text="添加美发师作品" />
    <br /><br /><asp:Button ID="btnBack" runat="server" OnClick="btnBack_Click" Text="返回美发师管理列表" />
    </div>
    </form>
</body>
</html>

...
{
    public class HairEngineerRecommand
    {
        #region HairEngineer Fields

        private int _hairEngineerRecommandID = 0;
        private int _hairEngineerRawID = 0;
        ...
        public int HairEngineerRecommandID
        {
            set { this._hairEngineerRecommandID = value; }
            get { return this._hairEngineerRecommandID; }
        }

        public int HairEngineerRawID
        {
            set { this._hairEngineerRawID = value; }
            get { return this._hairEngineerRawID; }
        }
        ...
        public string HairEngineerRecommandEx
        {
            set { this._hairEngineerRecommandEx = value; }
            get { return this._hairEngineerRecommandEx; }
        }

        public string HairEngineerRecommandInfo
        {
